      ...
      <div>
        <div className="card mt-1">
          <div className="card-body align-items-center d-flex justify-content-center">
            <h5>
              Mint Your Medical Article With True Rating Using IOT based True
              Ratings
            </h5>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center">
              {/* Select image component */}
               <img src="https://tse3.mm.bing.net/th?id=OIP.cicp5yRIK2PLNv1AqwPaOgHaHa&pid=Api&P=0&w=300&h=300"></img>
